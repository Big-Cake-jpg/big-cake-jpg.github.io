            ...
            <div class="navbar-menu">
                ...
                <div class="navbar-end">
                    <span class="flex flex-row" v-for="item in themeConfig.quickAccess">
                        <a class="navbar-item" :href="item.url" :aria-label="item.name" target="_blank">
                            <span class="icon text-xl" :class="item.icon" />
                        </a>
                    </span>
                    <a class="navbar-item" href="https://www.travellings.cn/go.html" aria-label="开往" target="_blank">
                        <span class="icon text-xl i-fluent-vehicle-subway-24-regular" />
                    </a>
                    <button class="navbar-item" :title="t('button.toggle_langs')" @click="toggleLocales"
                        aria-label="Switch locale">
                        <div class="icon text-xl i-ri-translate transition transform"
