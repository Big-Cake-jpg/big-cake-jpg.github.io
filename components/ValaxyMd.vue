...
if (
  typeof props.frontmatter.medium_zoom === "undefined" ||
  props.frontmatter.medium_zoom
)
  useMediumZoom();
</script>
...
<template>
  <article
    v-if="$slots.default"
    :class="frontmatter.markdown !== false && 'markdown-body'"
  >
